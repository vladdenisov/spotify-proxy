module.exports = [
  ...
  'login*.spotify.com', // ???
  '*.2mdn.net', // Just don't block it
  '*.ap.spotify.com', // Just don't block it
  'ns*.p*.dynect.net', // Just don't block it
  'dns*.p*.nsone.net', // Just don't block it
  '35.190.*', // Just don't block it
  '104.199.*' // Just don't block it
]
